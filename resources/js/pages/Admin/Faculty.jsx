                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {filteredFaculty.length > 0 ? filteredFaculty.map((prof) => (
                        ...
                        <div className="col-span-full text-center py-16 bg-slate-50 rounded-2xl border border-slate-100">
                            ...
                            <p className="text-sm font-bold text-slate-800">No faculty schedules found.</p>
                            <p className="text-xs text-slate-500 mt-1">Click "+ Add Faculty" to create a new schedule.</p>
                        </div>
                    )}
                </div>
            </div>

            ...
            <div className="max-w-7xl mx-auto flex justify-between items-center">
                ...
                <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2">
                        ...
                        <div className="w-10 h-10 bg-green-600 rounded-full border-2 border-yellow-400 flex items-center justify-center text-white text-xs font-bold">Logo</div>
                        <div className="w-10 h-10 bg-blue-100 rounded-full border-2 border-blue-600 flex items-center justify-center text-blue-800 text-xs font-bold">CED</div>
                    </div>
                </div>

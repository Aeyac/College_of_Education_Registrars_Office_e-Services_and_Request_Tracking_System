...
export default function Footer() {
    ...
    return (
        <footer className="bg-white text-slate-600 py-12 px-6 md:px-12 w-full mt-auto border-t border-slate-200">
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">

                {/* Brand & Info Section */}
<div className="flex flex-col gap-2">
    <div>
        <h3 className="font-extrabold text-slate-900 text-xl tracking-wide leading-tight">
    ...
    <p className="text-sm leading-relaxed text-slate-500 mt-1">
        ...
        College of Education
                ...
                <div className="flex flex-col gap-2.5">
                    <h4 className="font-bold text-slate-900 text-base mb-1">Quick Links</h4>
                    <a
                        href="https://oad.clsu.edu.ph/home"
                        target="_blank"
                        rel="noopener noreferrer"
                        className="hover:text-yellow-600 text-sm transition-colors w-fit"
                    >
                        Central Luzon State University
                    </a>
                    <Link href="#" className="hover:text-yellow-600 text-sm transition-colors w-fit">
                        Academic Services
                    </Link>
                    ...
                    <button
                        ...
                        className="hover:text-yellow-600 text-sm transition-colors w-fit text-left outline-none cursor-pointer"
                    >
                ...
                <div className="flex flex-col gap-3">
                    <h4 className="font-bold text-slate-900 text-base mb-1">Contact Us</h4>
                    <div className="text-sm flex items-center gap-2.5 text-slate-600">
                        ...
                        <a href="tel:+632345678901" className="hover:text-yellow-600 transition-colors">
                            Call Us: +63 (234) 567-8901
                        </a>
                    </div>
                    <div className="text-sm flex items-center gap-2.5 text-slate-600">
                        <svg className="w-4 h-4 text-yellow-500 shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
                        ...
                        <a href="mailto:info@cedservices.com" className="hover:text-yellow-600 transition-colors">
                            info@cedservices.com
                        </a>
                    </div>
                </div>
                ...
                {/* Social Media */}
                <div className="flex flex-col gap-3">
                    <h4 className="font-bold text-slate-900 text-base mb-1">Connect With Us</h4>
                    <div className="flex gap-3">
                        {/* Facebook */}
                        <a href="#" className="w-9 h-9 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-yellow-400 hover:text-slate-900 transition-colors" aria-label="Facebook">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                <path d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" />
                            </svg>
                        </a>
                        {/* X / Twitter */}
                        <a href="#" className="w-9 h-9 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-yellow-400 hover:text-slate-900 transition-colors" aria-label="Twitter">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                            </svg>
                        </a>
                        {/* LinkedIn */}
                        <a href="#" className="w-9 h-9 rounded-full bg-slate-100 text-slate-600 flex items-center justify-center hover:bg-yellow-400 hover:text-slate-900 transition-colors" aria-label="LinkedIn">
                            <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
            ...
            <div className="max-w-7xl mx-auto mt-12 pt-6 border-t border-slate-200 text-left text-xs text-slate-400">
            ...
            {openModal && (
                <div
                    className="fixed inset-0 bg-slate-950/60 backdrop-blur-sm z-[300] flex items-center justify-center p-4 sm:p-6 overflow-hidden text-left cursor-default"
                    onClick={closeModal}
                >
                    <div
                        className="bg-white w-full max-w-3xl rounded-3xl shadow-2xl flex flex-col max-h-[85vh] overflow-hidden animate-in zoom-in-95 duration-200"
                    ...
                    >
                        ...
                        <div className="px-6 py-4 flex justify-between items-center border-b border-slate-100 bg-slate-50 shrink-0">
                            ...
                            <button
                                type="button"
                                onClick={closeModal}
                                className="p-1.5 bg-white rounded-full text-slate-400 hover:text-slate-800 shadow-sm border border-slate-200 transition-colors outline-none cursor-pointer m-0"
                            >
                        ...
                        <div className="flex-1 overflow-y-auto p-6 sm:p-8 custom-scrollbar bg-white text-slate-600 text-sm">
                            ...
                            {openModal === 'about' && (
                                <div className="leading-relaxed">
                                    ...
                                    <p className="mb-4 text-slate-600 text-xs">
                                        The CED E-Services Portal was conceptualized, designed, and brought to life by a dedicated team of aspiring IT professionals. Driven by the goal to modernize academic transactions, this system stands as a testament to their collaboration and technical expertise.
                                    </p>
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3 mb-6">
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                            ...
                                            <span className="text-xs text-slate-800 font-bold mt-0.5 block uppercase tracking-wide">Scrum Master | Full-Stack Developer</span>
                                            <span className="text-[10px] text-slate-500 font-medium mt-1 block uppercase tracking-wide">BS Information Technology <br /> Major in Systems Development</span>
                                        </div>
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                            <strong className="block text-slate-900 text-sm">MEL JOSEPH T. VELASCO</strong>
                                            <span className="text-xs text-slate-800 font-bold mt-0.5 block uppercase tracking-wide">Full-Stack Developer</span>
                                            <span className="text-[10px] text-slate-500 font-medium mt-1 block uppercase tracking-wide">BS Information Technology <br /> Major in Systems Development</span>
                                        </div>
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                        ...
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                            ...
                                            <span className="text-xs text-slate-800 font-bold mt-0.5 block uppercase tracking-wide">UI/UX Designer</span>
                                            <span className="text-[10px] text-slate-500 font-medium mt-1 block uppercase tracking-wide">BS Information Technology <br /> Major in Systems Development</span>
                                        </div>
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                        ...
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                            ...
                                            <span className="text-xs text-slate-800 font-bold mt-0.5 block uppercase tracking-wide">Documentator & UI/UX Designer</span>
                                            <span className="text-[10px] text-slate-500 font-medium mt-1 block uppercase tracking-wide">BS Information Technology <br /> Major in Systems Development</span>
                                        </div>
                                        <div className="bg-white border border-slate-200 p-3 rounded-xl shadow-sm hover:border-yellow-400 transition-colors">
                                            <strong className="block text-slate-900 text-sm">JAYVEELYN C. VICENTE</strong>
                                            <span className="text-xs text-slate-800 font-bold mt-0.5 block uppercase tracking-wide">Quality Assurance (QA)</span>
                                            <span className="text-[10px] text-slate-500 font-medium mt-1 block uppercase tracking-wide">BS Information Technology <br /> Major in Systems Development</span>
                                        </div>
                                    </div>
                        ...
                        <div className="p-4 border-t border-slate-100 bg-white shrink-0">
                            <button
                                type="button"
                                onClick={closeModal}
                                className="w-full py-3 bg-slate-900 hover:bg-slate-800 text-white font-bold rounded-xl transition-colors shadow-md text-sm outline-none cursor-pointer m-0"
                            >
                                Close Document
                            </button>
                        </div>
